...
latex_documents = [
  ('index', 'toga-chart.tex', u'Toga-Chart Documentation',
...
man_pages = [
    ('index', 'toga-chart', u'Toga-Chart Documentation',
...
texinfo_documents = [
  ('index', 'toga-chart', u'Toga-Chart Documentation',
   u'Russell Keith-Magee', 'Toga-Chart', 'Tools to support development of Python on mobile platforms.',
   'Miscellaneous'),
]
